...
namespace TMPro
{
    public enum Emotion { normal,happy,scared };
            ...
            IEnumerator Read()
            {
                ...
                WaitForSeconds EvaluateTag(string tag)
                {
                    if (tag.Length > 0)
                    {
                        ...
                        {
                            print(tag);
                            print(System.Enum.Parse(typeof(Emotion), tag.Split('=')[1]));
                            print((Emotion)System.Enum.Parse(typeof(Emotion), tag.Split('=')[1]));
